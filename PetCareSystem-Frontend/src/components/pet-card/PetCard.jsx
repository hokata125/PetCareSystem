const PetCard = ({ image, name, petType, age, weight }) => {
  return (
    <div className="flex h-80 cursor-pointer flex-col rounded-3xl border-4 border-brand-primary bg-white p-4 transition-transform duration-200 hover:scale-105 xl:h-88 2xl:h-96 3xl:h-104">
      ...
      <button
        type="button"
        className="flex h-12 cursor-pointer items-center justify-center rounded-lg border-0 bg-brand-primary text-lg leading-none text-white hover:bg-brand-primary-hover 2xl:h-14 2xl:text-xl"
      >
